...
#  NOTA: Se aggregate.stage non è NULL, per diminuire l'uso di        #
#        memoria e la complessità computazionale, la funzione:        #
...
#        3) espande gli g-weights calcolati in 2) sulle unità finali. #
